...
import { bookmarks } from '../../db/d1/schema'
import type {
  BookmarkRepository,
  BookmarkTagSummary,
  CreateBookmarkInput,
...
function affected(result: { meta?: { changes?: number } }): boolean {
  return (result.meta?.changes ?? 0) > 0
}

export function createD1BookmarkRepository(db: D1Db): BookmarkRepository {
  return {
