...
export const InputWithIcon = ({
  ...
  return (
    <div className="flex w-full min-w-0 items-center rounded-sm bg-gray-100 pl-3 has-[input:focus-within]:-outline-offset-1 has-[input:focus-within]:outline has-[input:focus-within]:outline-gray-500">
