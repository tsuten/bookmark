...
function SidebarUserSection() {
  const displayName = MOCK_USER.displayName;
      ...
      <DropdownMenu.Root>
        ...
        <DropdownMenu.Portal>
          <DropdownMenu.Content
            ...
            sideOffset={4}
          >
            <DropdownMenu.Item className="sidebar-user-menu-item" asChild>
              <Link to="/login">
...
export function Sidebar() {
  ...
  const [pinned, setPinned] = useState<string[]>(MOCK_PINNED_TAGS);
